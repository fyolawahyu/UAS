...
#READ DATA JSON DAN MEMBUAT DATA FRAME 1
...
#READ DATA CSV DAN MEMBUAT DATA FRAME 1
...
#MEMBUAT DATA FRAME 2 TIAP FILE
...
#MENGATUR LETAK OUTPUT JUDUL SIDEBAR
...
#MEMBUAT DATA FRAME NEGARA PRODUKSI TERBESAR
dfb = dfC_2.loc[dfC_2['tahun'] == tahun]
dfb = dfb.sort_values(by='produksi', ascending = False)
dfbaru = dfb[:n]

#OUTPUT TABEL NEGARA PRODUKSI TERBESAR
lcol.write(dfbaru)

#OUTPUT GRAFIK NEGARA PRODUKSI TERBESAR
...
#MENGUMPULKAN DATA KUMULATIF TIAP NEGARA
for i in list (dfC_2['kode_negara']) :
    if i not in list_a:
        list_a.append(i)
...
#MEMBUAT DATA FRAME NEGARA PRODUKSI KUMULATIF TERBESAR 
...
#OUTPUT TABEL NEGARA PRODUKSI KUMULATIF TERBESAR
lc.write(dk1)

#OUTPUT GRAFIK NEGARA PRODUKSI KUMULATIF TERBESAR
